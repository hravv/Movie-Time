...
const MovieList = ({list, setList, URL, searchInput, setSearchInput, submittedSearch, handleSearchSubmit}) => {
  ...
  return (
    <section className='movie-list bg-black/70 min-h-300 mb-30 pb-20 flex flex-col'>
      <header className='movies-header flex justify-center xl:justify-end'>
        <div className='movie-list-filters flex mx-auto w-100 lg:w-fit h-fit lg:mr-20 lg:mt-25 mb-25 px-2 sm:px-4 lg:px-8 gap-x-2 border-neonblue border-b-4 relative'>
      ...
      <div className='mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-14 w-full px-2'>
